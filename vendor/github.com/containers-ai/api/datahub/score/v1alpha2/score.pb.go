...
package v1alpha2 // import "github.com/containers-ai/api/datahub/score/v1alpha2"
...
func (*SimulatedSchedulingScore) Descriptor() ([]byte, []int) {
	return fileDescriptor_score_3c943ef93102a932, []int{0}
}
...
func init() {
	proto.RegisterFile("datahub/score/v1alpha2/score.proto", fileDescriptor_score_3c943ef93102a932)
}

var fileDescriptor_score_3c943ef93102a932 = []byte{
